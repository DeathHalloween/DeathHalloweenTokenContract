...
contract DeathHalloweenToken is IERC20 {
    ...
    string constant private _name = "Death Halloween Token";
    string constant private _symbol = "DEATH";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xDd32616568A625451bC2872c6FE04961ae139b28), //Marketing
        development: payable(0xea115B5Da77b716734b96378409A7Cc34aF00b08) //DEV
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 development, uint16 liquidity, uint16 marketing) external onlyOwner {
